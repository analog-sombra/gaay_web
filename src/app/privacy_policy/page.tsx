      ...
      <div className="bg-white p-8 shadow rounded-md w-full mt-3">
        <section className="mb-8">
          <p className="text-lg mt-2">
            ...
            https://dnhddscstcorporation.com/, or the DNH DD SC ST Web
            Application application (collectively, “DNH DD SC ST GAAY Platform”)
            made available by Planning and Development Authority ,DNH (“DNH DD
            SC ST”, “Company”, “we”, “us” and “our”), a Government establishment
            established under the laws of India having its registered office at
            “B” Wing ,Second Floor,District Secretariat,Silvassa-396230.
          </p>
          <p className="text-lg mt-2">
            The terms “you” and “your” refer to the user of the DNH DD SC ST
            GAAY Platform. The term “Services” refers to any services offered by
            DNH DD SC ST whether on the DNH DD SC ST GAAY Platform or otherwise.
          </p>
          <p className="text-lg mt-2">
            Please read this Policy before using the DNH DD SC ST GAAY Platform
            or submitting any personal information to DNH DD SC ST. This Policy
            is a part of and incorporated within, and is to be read along with,
            the Terms of Use.
          </p>
        </section>
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            By using the DNH DD SC ST GAAY Platform and the Services, you agree
            and consent to the collection, transfer, use, storage, disclosure
            and sharing of your information as described and collected by us in
            accordance with this Policy. If you do not agree with the Policy,
            please do not use or access the DNH DD SC ST GAAY Platform.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            such changes, such as via prominent notice on the DNH DD SC ST GAAY
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            the DNH DD SC ST GAAY Platform;
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            Our DNH DD SC ST GAAY Platform and third parties with whom we
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            features to personalise your DNH DD SC ST GAAY account;
          </p>
          <p className="text-lg mt-2">
          ...
          <p className="text-lg mt-2">
            To administer and enhance the security of our DNH DD SC ST GAAY
          ...
          <p className="text-lg mt-2">
            If you are a merchant or delivery partner, to track the progress of
            delivery or status of the order placed by our customers.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            password which enables you to access certain parts of the DNH DD SC
            ST GAAY Platform, you are responsible for keeping these details
          ...
          <p className="text-lg mt-2">
            ...
            data transmitted through the DNH DD SC ST GAAY Platform. Once we
            have received your information, we will use strict physical,
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            dnhddscst@gmail.com. Please note that we may take time to process
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">
            9. GRIEVANCE OFFICER AND DNH DD SC ST GAAY PLATFORM SECURITY
          </h2>
          <p className="text-lg mt-2">
            ...
            email us at dnhddscst@gmail.com or write to our Grievance Officer at
            the following address:
          </p>
          <p className="text-lg mt-2">
            If you come across any abuse or violation of the Policy, please
            report to dnhddscst@gmail.com.
          </p>
          <p className="text-lg mt-2">
            Further, please note that the DNH DD SC ST GAAY Platform stores your
            data with the cloud platform of Hostinger Web Services provided by
        ...
        <section className="mb-8">
          ...
          <p className="text-lg">Email: dnhddscst@gmail.com</p>
        </section>
      </div>
    </div>
  );
